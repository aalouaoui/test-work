...
export declare const SIZING = "sizing";
...
export declare const BLEND = "blend";
export declare const MIX = "mix";
export declare const ISOLATE = "isolate";
...
export declare const PLAY_STATE = "play-state";
export declare const VISIBILITY = "visibility";
export declare const INVISIBLE = "invisible";
export declare const VISIBLE = "visible";
export declare const Z_INDEX = "z-index";
export declare const CLEAR = "clear";
export declare const BEHAVIOR = "behavior";
export declare const OVERSCROLL_BEHAVIOR: string;
export declare const Y = "y";
export declare const X = "x";
export declare const WEIGHT = "weight";
...
export declare const OVERFLOW = "overflow";
...
export declare const GRAYSCALE = "grayscale";
export declare const SMOOTHING = "smoothing";
export declare const SHARP = "sharp";
export declare const ANTIALIASED = "antialiased";
export declare const SUBPIXEL = "subpixel";
export declare const LETTER = "letter";
export declare const FIRST = "first";
export declare const SPACING = "spacing";
export declare const LETTER_SPACING: string;
export declare const MAX_WIDTH: string;
export declare const MIN_WIDTH: string;
export declare const MAX_HEIGHT: string;
export declare const MIN_HEIGHT: string;
export declare const FONT_PREFIX = "font:";
export declare const F_PREFIX = "f:";
export declare const T_PREFIX = "t:";
export declare const H_PREFIX = "h:";
export declare const W_PREFIX = "w:";
export declare const BG_PREFIX = "bg:";
export declare const OBJECT_PREFIX: string;
...
export declare const RATIO = "ratio";
export declare const AFTER = "after";
export declare const BEFORE = "before";
export declare const INSIDE = "inside";
export declare const TABLE = "table";
export declare const GROUP = "group";
export declare const LIST = "list";
export declare const ITEM = "item";
export declare const BASIS = "basis";
export declare const FULL = "full";
export declare const REVERSE = "reverse";
export declare const NOWRAP = "nowrap";
export declare const FLEX_PREFIX: string;
export declare const GROW = "grow";
export declare const BOX_PREFIX: string;
export declare const SHRINK = "shrink";
export declare const ORDER = "order";
export declare const ORDER_PREFIX = "o:";
...
export declare const THICKNESS = "thickness";
...
export declare const HUE = "hue";
export declare const SIZING_VALUES: {
    full: string;
    fit: string;
    max: string;
    min: string;
